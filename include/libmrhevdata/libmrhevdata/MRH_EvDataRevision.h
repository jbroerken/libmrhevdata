...
#ifndef MRH_EvDataRevision_h
#define MRH_EvDataRevision_h
...
extern "C"
{
    ...
    extern int MRH_GetEvDataLibraryVersionMajor(void);
    ...
    extern int MRH_GetEvDataLibraryVersionMinor(void);
    ...
    extern int MRH_GetEvDataLibraryVersionPatch(void);
...
#define MRH_EV_DATA_LIB_VERSION_MINOR 0
#define MRH_EV_DATA_LIB_VERSION_PATCH 0


#endif /* MRH_EvDataRevision_h */
